"use strict";
const ACTION_SET_STATE = require('./../constants').ACTION_SET_STATE;
const ACTION_ASSIGN_REDUCER = require('./../constants').ACTION_ASSIGN_REDUCER;
const ACTION_RUN = require('./../constants').ACTION_RUN;
const LAST_REDUCER = require('./../constants').LAST_REDUCER;
const ENV = require('./../constants').ENV;
const singular = require('reciprocator');
